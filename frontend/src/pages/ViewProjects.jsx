        ...
        <div className="p-6"><br></br><br></br>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project) => (
              <div
                key={project._id}
                className="border rounded-lg p-4 bg-white/90 backdrop-blur-md shadow hover:shadow-lg transition"
              >
          ...
          {selectedProject && (
            <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 px-4">
              <div className="bg-white/95 backdrop-blur-md rounded-xl shadow-2xl max-w-4xl w-full p-6 relative overflow-y-auto max-h-[90vh]">
                <button
