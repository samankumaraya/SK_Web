          ...
          {experiences.length === 0 ? (
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {experiences.map((exp) => (
                <div
                  key={exp._id}
                  className="bg-white/90 backdrop-blur-md shadow-md rounded-lg p-6 border border-gray-100 hover:shadow-lg transition-shadow flex flex-col justify-between"
                >
                  <div>
