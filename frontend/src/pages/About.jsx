...
const About = () => {
  ...
  return (
    <div>
      ...
      <section
        id="about"
        className="flex flex-col items-center py-8 md:py-24 relative overflow-hidden"
      >
        ...
        <div className="max-w-6xl w-full px-2 sm:px-6 lg:px-5 relative z-5">
          <div className="bg-white rounded-3xl shadow-2xl p-1 sm:p-8 md:p-16">
            
            <div className="text-center mb-5 md:mb-12">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-1 sm:mb-1 text-green-600">
                About Me
              </h2>
